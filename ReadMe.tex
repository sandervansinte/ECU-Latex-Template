%% Version 2.0 (13-03-2026) https://github.com/sandervansinte/ECU-LaTeX-Template.git
...
% To change the citation style simply do so in packages.tex in the biblatex usepackege string

% -------------------------------------------------------------------------
%% Update History %%

% Update Version 2.0 (13-03-2026):
% - Added the function to have preset layouts for the content that is loaded depending on the document type (article, custom, report, research proposal, BSc or MSc, and PhD).
% The custom document type is the default type and it requires just uncommenting the lines of content you want to include in the main.tex file.
% - Selecting a document type will now result in custom formatting and titlepages. For example, articles will uniquely not have a title page, and the document will be formatted in a double column style. 
% - included dynamic citation style selection in the packages.tex file.